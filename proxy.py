...
class ProxyServer:
    ...
    def __init__(self, port: int, restricted_rsc: RestrictedResource = None):
        self.port = port
        self._restricted_rsc = restricted_rsc
    ...
    async def _handle_http(
        ...
        try:  # weird http urls
            ...
            self._logger.info(
                CONNECTION_REFUSED_MSG.format(method=r.method, url=r.url)
            )
            return
